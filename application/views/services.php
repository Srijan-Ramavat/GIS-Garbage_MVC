...
<body>
	...
	<div id="fh5co-wrap">
			...
			<div class="container">
				<nav class="fh5co-main-nav">
					<ul>
                        ...
                        <li class="fh5co-active"><a href="<?php echo base_url();?>Home/services"><span>Services</span></a></li>
		...
		<div class="fh5co-hero" style="background-image: url(<?php echo asset_url();?>images/hero_2.jpg);" data-stellar-background-ratio="0.5">
		...
		<div class="fh5co-parallax" style="background-image: url(<?php echo asset_url();?>images/hero_2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
